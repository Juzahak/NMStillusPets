  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.right}>
          <div className={styles.wrapper}>
            ...
            <div className={styles.totalText}>
              <span className={styles.totalTextTitle}>SUBTOTAL:</span>R${cart.total.toFixed(2)}
            </div>
            <div className={styles.totalText}>
            ...
            {select === "Mercado Livre" ?
              ...
              <>
                <div className={styles.totalText}>
                  ...
                  <span className={styles.totalTextTitle}>ENTREGA:</span>R${price.toFixed(2)}

                </div>
                <div className={styles.totalText}>
                  <span className={styles.totalTextTitle}>TOTAL:</span>R${(cart.total + price).toFixed(2)}
                </div>
        ...
        {cash && <OrderDetail entrega={price} total={cart.total} produto={cart.products} metodo={metodo} size={cart.products.size} createOrder={createOrder} setCash={setCash} />}
      </div>
      <Footer />
    </>
  );
